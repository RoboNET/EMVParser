...
internal static class HexConverter
{
    ...
    public static void ToBytesBuffer(byte value,
        Span<byte> buffer,
        int startingIndex = 0,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void ToCharsBuffer(byte value,
        Span<char> buffer,
        int startingIndex = 0,
        Casing casing = Casing.Upper)
    {
...
#pragma warning restore CS8500 // This takes the address of, gets the size of, or declares a pointer to a managed type
 ...
 Vector128.Shuffle(output, Vector128.Create((byte)0, 2, 4, 6, 8, 10, 12, 14, 0, 0, 0, 0, 0, 0, 0, 0));
            ...
            bool fallbackResult =
 TryDecodeFromUtf16_Scalar(chars.Slice((int)offset), bytes.Slice((int)(offset / 2)), out int fallbackProcessed);
